...
- No happy (EP), negative (NEG), and boundary (BVA) case represented anywhere in the pack, with no `Not applicable: <reason>` given
- A Critical or High risk from the register is in scope but has zero cases tracing to it
